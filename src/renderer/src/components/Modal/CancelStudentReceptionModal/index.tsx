...
export const CancelStudentReceptionModal: React.FC<CancelStudentReceptionModalProps> = ({ receptionModalIsOpen, handleModal, cancelReception, handleResrtInputStudentId }) => {
